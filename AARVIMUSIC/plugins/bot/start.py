...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        out = private_panel(_)
        AARVI = await message.reply_text(f"**कुछ अलग ही था**")
        await AARVI.edit_text(f"**हमारे रिश्ते**")
        await AARVI.edit_text(f"**का रंग**")
        await AARVI.edit_text(f"**तुम्हारे जान**")
        await AARVI.edit_text(f"**से वो अधूरा**")
        await AARVI.edit_text(f"**रह गया**")
        await AARVI.edit_text(f"**पर मेरे दिल**")
        await AARVI.edit_text(f"**में आज भी वो**")
        await AARVI.edit_text(f"**रंग कायम**")
        await AARVI.edit_text(f"**है जोया जी**")
        await AARVI.edit_text(f"**कुछ अलग ही था हमारे रिश्ते का रंग तुम्हारे जाने से वो अधूरा रह गया पर मेरे दिल में आज भी वो रंग कायम है जोया जी**")
        await AARVI.edit_text(f"**❖ ʙᴀʙʏ ᴍᴜsɪᴄ sᴛᴀʀᴛᴇᴅ..**")
        await AARVI.delete()
